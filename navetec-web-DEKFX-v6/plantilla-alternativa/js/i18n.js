/* ==========================================================================
   DEKFX - Plantilla Alternativa - Sistema de idiomas (Español / English)
   ========================================================================== */
...
const I18N_DICT = {
    es: {
        ...
        hero_kicker: "Boat Flooring a medida",
        hero_title_1: "Safety &amp; comfort,",
        hero_title_2: "a bordo de tu barco.",
        hero_desc: "Suelo antideslizante, impermeable y a medida para yates, veleros y lanchas. Diseño CAD, corte de precisión e instalación profesional.",
        hero_btn_calc: "Calcular mi Cubierta",
        hero_btn_before_after: "Ver Antes y Después",
        stat1_num: "15+",
        stat1_label: "Años de experiencia",
        stat2_num: "500+",
        stat2_label: "Barcos equipados",
        stat3_num: "48h",
        stat3_label: "Respuesta de cotización",
        ...
        svc2_desc: "Diseños completamente a medida. Incorporamos patrones clásicos, líneas deportivas de calafateado, o grabamos el logotipo y nombre de su embarcación mediante tecnología láser de precisión.",
        svc3_title: "Restauración y Desmantelado (Refit)",
        svc3_desc: "Retiramos cubiertas viejas de teca natural deteriorada o residuos de moqueta marina y pinturas desgastadas. Dejamos el sustrato de fibra de vidrio impecable para la nueva instalación.",
        ...
        ba_desc: "Arrastra el control central para ver la diferencia entre la cubierta desgastada y la nueva superficie instalada.",
        ...
        calc_desc: "Usa esta herramienta para proyectar los costes preliminares según tu barco.",
    ...
    en: {
        ...
        hero_kicker: "Custom Boat Flooring",
        hero_title_1: "Safety &amp; comfort,",
        hero_title_2: "aboard your boat.",
        hero_desc: "Non-slip, waterproof, custom flooring for yachts, sailboats and speedboats. CAD design, precision cutting and professional installation.",
        hero_btn_calc: "Calculate My Deck",
        hero_btn_before_after: "See Before & After",
        stat1_num: "15+",
        stat1_label: "Years of experience",
        stat2_num: "500+",
        stat2_label: "Boats equipped",
        stat3_num: "48h",
        stat3_label: "Quote response time",
        ...
        svc3_desc: "We remove old, deteriorated natural teak decks or worn marine carpet residue and paint. We leave the fiberglass substrate spotless for the new installation.",
        ...
        calc_desc: "Use this tool to project preliminary costs based on your boat.",
...
function updateLangButtons() {
    document.querySelectorAll('[data-lang-btn]').forEach((btn) => {
        ...
        btn.classList.toggle('bg-dek-ink', isActive);
        btn.classList.toggle('text-white', isActive);
        btn.classList.toggle('text-dek-inkfaint', !isActive);
    });
}
